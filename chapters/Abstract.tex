...
This thesis investigates the associations between \isi{information structure}
...
The thesis outlines \isi{word order} in spoken Japanese in a unified framework.

\newpage 
Chapter \ref{Intonation} investigates intonation.
While the previous literature mainly concentrates on \isi{contrastive focus},
this thesis discusses in terms of both \isi{topic} and focus.
