...
There are two kinds of roots of studies on \isi{information structure}
(see \citeA{kruijff-korbayovasteedman03} for a useful survey).
One started from studies on definite and \isi{indefinite} descriptions by \citeA{russell05} and \citeA{strawson50,strawson64}.
...
I provide an overview of the previous studies on \isi{information structure} in across languages.
